...
public class LessonPlanAdapter extends RecyclerView.Adapter<LessonPlanAdapter.Myholder> {
    ArrayList<LessonPlanModel> arrayList;
    Context context;

    public LessonPlanAdapter(ArrayList<LessonPlanModel> arrayList, Context context) {
