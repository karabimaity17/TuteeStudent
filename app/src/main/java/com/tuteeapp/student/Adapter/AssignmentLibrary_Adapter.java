...
public class AssignmentLibrary_Adapter extends RecyclerView.Adapter<AssignmentLibrary_Adapter.MyViewHolder> {

    Context context;
    List<ExerciseLibrary_Model> exerciseLibrary_models = new ArrayList<>();

    public AssignmentLibrary_Adapter(Context context, List<ExerciseLibrary_Model> exerciseLibrary_models) {
        ...
        if (exerciseLibrary_models.get(position).getChecked().equals("Y")){
            ...
            holder.card_exercise.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    context.startActivity(new Intent(context, Assignments.class));
                }
            });
        }
    }
