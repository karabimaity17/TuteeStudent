...
import com.tuteeapp.student.ScreenInvitation;
import com.google.android.material.bottomsheet.BottomSheetDialog;

import java.util.ArrayList;
import java.util.List;

public class All_InviteShareFragment extends Fragment {
        ...
        public void onBindViewHolder(@NonNull TeacherAdapter.MyViewHolder holder, int position) {
            ...
            holder.linear_teacher.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                       context.startActivity(new Intent(context, ScreenInvitation.class));
