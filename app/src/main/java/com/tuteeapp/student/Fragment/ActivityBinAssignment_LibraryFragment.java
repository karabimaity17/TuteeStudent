...
import com.tuteeapp.student.Adapter.AssignmentLibrary_Adapter;
...
public class ActivityBinAssignment_LibraryFragment extends Fragment {

    RecyclerView recycler_view;
    List<ExerciseLibrary_Model> exerciseLibrary_models;
    AssignmentLibrary_Adapter exerciseLibrary_adapter;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_assignment_library,container,false);
        ...
        exerciseLibrary_adapter = new AssignmentLibrary_Adapter(getActivity(),exerciseLibrary_models);
