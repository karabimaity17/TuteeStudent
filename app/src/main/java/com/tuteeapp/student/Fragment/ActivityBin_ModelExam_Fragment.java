...
public class ActivityBin_ModelExam_Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        model.add(new Model_Exam("Final","","Exam Date: 19.12.20","U"));
        model.add(new Model_Exam("3rd Term","Percentile 89%","Exam Date: 19.12.20","U"));
