...
public class Chapter_Library_Fragment extends Fragment {
  ...
  //  ViewPagerAdapter viewPagerAdapter;
    ...
    List<ChapterLibraryModel> model2=new ArrayList<>();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
      ...
      //  viewPager.setPageTransformer(true,null);
        ...
        model.add(new ChapterLibraryModel("Content Forces and Newtons Law","English","Lesson code : 32654","05.10.2020","View 132","L"));
        model.add(new ChapterLibraryModel("Content Forces and Newtons Law","English","Lesson code : 32654","05.10.2020","View 132","L"));
        model.add(new ChapterLibraryModel("Content Forces and Newtons Law","English","Lesson code : 32654","05.10.2020","View 132","U"));

        model2.add(new ChapterLibraryModel("Content Forces and Newtons Law","English","Lesson code : 32654","05.10.2020","View 132","U"));
        model2.add(new ChapterLibraryModel("Content Forces and Newtons Law","English","Lesson code : 32654","05.10.2020","View 132","U"));
        model2.add(new ChapterLibraryModel("Content Forces and Newtons Law","English","Lesson code : 32654","05.10.2020","View 132","U"));
        MonthModel.add(new MonthModel("February",model));
        MonthModel.add(new MonthModel("January",model2));
