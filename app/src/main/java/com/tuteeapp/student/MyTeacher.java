...
import com.tuteeapp.student.Fragment.All_TeacherFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cardsearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ArrayAdapter<String> arrayAdapterboard = new ArrayAdapter<String>(MyTeacher.this, android.R.layout.simple_dropdown_item_1line, Board);
                spinboard.setAdapter(arrayAdapterboard);
                ArrayAdapter<String> arrayAdaptersyllabus = new ArrayAdapter<String>(MyTeacher.this, android.R.layout.simple_dropdown_item_1line, Syllabus);
                spinsyllabus.setAdapter(arrayAdaptersyllabus);
                ArrayAdapter<String> arrayAdaptersubject = new ArrayAdapter<String>(MyTeacher.this, android.R.layout.simple_dropdown_item_1line, Subject);
                spinsubject.setAdapter(arrayAdaptersubject);
                ArrayAdapter<String> arrayAdapternation = new ArrayAdapter<String>(MyTeacher.this, android.R.layout.simple_dropdown_item_1line, Nation);
                spinnation.setAdapter(arrayAdapternation);
                ArrayAdapter<String> arrayAdaptercountry = new ArrayAdapter<String>(MyTeacher.this, android.R.layout.simple_dropdown_item_1line, Country);
                ...
                cardsearching.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        myDialog.dismiss();
                        getSupportActionBar().setTitle("My Teachers");
                    }
                });
        ...
        lin_chat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(MyTeacher.this,ChatActivity.class));
        ...
        lin_screen_share.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(MyTeacher.this,ScreenShare.class));
                overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
                finish();
            }
        });
        lin_group.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(MyTeacher.this,Group.class));
                overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
                finish();
            }
        });
...
//        });
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.menu_home:
                        Intent i1 = new Intent(MyTeacher.this, EduMe.class);
                        startActivity(i1);
                        overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
                        break;
                    case R.id.menu_profile:
                        Intent i2 = new Intent(MyTeacher.this, EditProfile.class);
                        startActivity(i2);
                        overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
                        break;
                    case R.id.menu_desktop:
                        Intent i3 = new Intent(MyTeacher.this, ConnectDesktop.class);
                        startActivity(i3);
                        overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
                        break;
                    case R.id.menu_feedback:
                        Intent i4 = new Intent(MyTeacher.this, FeedbackActivity.class);
                        startActivity(i4);
                        overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
                        break;
                    case R.id.menu_account:
                        Intent i5 = new Intent(MyTeacher.this, MyAccount.class);
                        startActivity(i5);
                        overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
                        break;
                    case R.id.menu_contact:
                        Intent i6 = new Intent(MyTeacher.this, ContactUs.class);
                        startActivity(i6);
                        overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
                        break;
                    case R.id.menu_settings:
                        startActivity(new Intent(MyTeacher.this, Settings.class));
                        overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
                        break;
                }
        ...
        bottomnav.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                if(id== R.id.menu_home2){
                    ...
                    startActivity(new Intent(MyTeacher.this,EduMe.class));
                    overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
                    finish();
                    ...
                    bottomnav.getMenu().getItem(2).setIcon(R.drawable.teacher);
                    startActivity(new Intent(MyTeacher.this,Analytics.class));
                    overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
                    finish();
                    ...
                    startActivity(new Intent(MyTeacher.this,Classroom.class));
                    overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
                    finish();
                    bottomnav.getMenu().getItem(2).setIcon(R.drawable.teacher);
                    ...
                    bottomnav.getMenu().getItem(2).setIcon(R.drawable.teacher);
                    startActivity(new Intent(MyTeacher.this,MyProfile.class));
                    overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
                    finish();
                }
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        viewPagerAdapter.addFragment(new All_TeacherFragment(), "All");
        viewPagerAdapter.addFragment(new All_TeacherFragment(), "Maths");
        viewPagerAdapter.addFragment(new All_TeacherFragment(), "Physics");
        viewPagerAdapter.addFragment(new All_TeacherFragment(), "English");
        viewPagerAdapter.addFragment(new All_TeacherFragment(), "Chemistry");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.shop:
                Intent i1 = new Intent(MyTeacher.this, CartActivity.class);
                startActivity(i1);
                overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
                return true;
            case R.id.bell:
                startActivity(new Intent(MyTeacher .this, Notification.class));
                overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
                return true;
        }
